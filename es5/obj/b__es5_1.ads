...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_es5_1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f6eec0f2#;
   pragma Export (C, u00001, "es5_1B");
